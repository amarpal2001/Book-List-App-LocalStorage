...
export const App = () => {
  ...
  return (
    <div className='wrapper'>
      ...
      <marquee style={{width:'30%'}}>Add and view your books using local storage</marquee>
      </div>
      <div className='main'>
        ...
        <div className='form-container'>
          ...
          onSubmit={handleAddBookSubmit}>
            ...
            <br></br>
            <label>ISBN#</label>
            <input type="text" className='form-control' placeholder="ISBN Number" required
        ...
        <div className='view-container'>
          ...
          {books.length < 1 && <div style={{textAlign:'center', color:'red'}}>No books are added yet</div>}
        </div>
